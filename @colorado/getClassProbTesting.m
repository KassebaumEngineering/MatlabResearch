...
function anArray = getClassProbTesting( p )
% getClassProbTesting - @colorado Class Method
%
%     p = getClassProbTesting( p )
%
% Description: Return an array of probability
...
% endfunction getClassProbTesting
