...
function anArray = getClassProb( p )
% getClassProb - @colorado Class Method
%
%     anArray = getClassProb( p )
%
% Description: Return an Array of class membership
